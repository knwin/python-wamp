#extract points in PostGIS database and streaming to Google Earth via Networklink
#apache web server from WAMP is used
# code start from line 5 
----------------------------------
#!C:/Python366/python.exe
import cgi
import sys
